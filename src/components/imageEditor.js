...
function ImageEditor() {
  ...
  function loadCanvas(file) {
      ...
      let canvas = document.getElementById('farbricCanvas');
      if(!canvas){
        canvas = document.createElement('canvas');
        canvas.id = 'farbricCanvas';
  ...
  function cropImg() {
    ...
    context.restore();
    var imgData = context.getImage(0,0, canvas.width, canvas.height);
  ...
  function applyButton() {
    ...
    if(id ==1){
      ...
      setFabricCanvasVisisble({dispay:"none"});
